...
namespace Rsvfx
{
    static class UnsafeUtility
    {
        ...
        public static void SetUnmanagedData
            (ComputeBuffer buffer, IntPtr pointer, int srcOffset, int bufferOffset, int count, int stride)
        {
            if (_method == null)
            {
            ...
            _args5[0] = pointer;
            _args5[1] = srcOffset;      // source offset
            _args5[2] = bufferOffset;      // buffer offset
            _args5[3] = count;
            _args5[4] = stride;
